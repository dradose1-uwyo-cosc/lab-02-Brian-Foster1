...
# Lab 02 
# Lab Section: 11
# Sources, people worked with, help given to: Johan , Matthew
# They both helped me understand how github works, otherwise thats it
# 
# 
...
uw_age = "1886"
print(f"The {uw} was founded in {uw_age}")
